...
import 'package:teste_tokenlab/presentation/movie/movie_list/empty_favorite_movie_list_widget_view.dart';
  ...
  Widget build(BuildContext context) => FocusDetector(
        ...
        child: StreamBuilder<FavoritesMovieResultState>(
            ...
            builder: (context, snapshot) => AsyncSnapshotMoviesResponseView<
                  ...
                  snapshot: snapshot,
                  errorWidget: const EmptyFavoriteMovieListWidgetView(
                    key: ValueKey('empty-favorite-movie-list-success-widget'),
                  ),
